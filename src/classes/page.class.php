...
/**
  ...
  �bernimmt alle Initialisierungen und die Authentifikation.
  Die Kinder �berschreiben die run Methode f�r die
  Funktionalit�ten.
*/
...
/**
  ...
  Stellt globale Funktionen f�r alle Seiten zur Verf�gung, �bernimmt
  alle Initialisierungen und �bernimmt den Loginvorgang.
*/
  /**
  * @return void
  * @param string $msg Variable
  * @param integer $tracking Anzahl der Funktionsaufrufe die zur�ckverfolgt werden
  ...
  */
  ...
  /**
    ...
    per GET oder POST �bergebener "action" Parameter
  */
  var $action;
  ...
  */
  function Page () {
    ...
    if (!$this->template) $this->_error("Templateengine l�sst sich nicht starten!");
